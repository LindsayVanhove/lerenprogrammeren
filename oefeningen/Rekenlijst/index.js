...
function myPrint() {
    ...
    titel.innerHTML += `<h2>De Oefeningen</h2>`
    while (x < hoeveelOef) { // Zolang x kleiner is dan het maximum ingegeven (VAN) getal, is er een loop:
       ...
       //  array3.push(array1[x] + array2[x]); // 3de getal is de oplossing van array 1 en array 2
        ...
        resultaat.innerHTML += `<p class="list-group-item px-2 border-0 rounded-3 list-group-item-primary mt-2 mx-2"> ${array1[x]} ${bewerking} ${array2[x]} = </p>`// Resultaten zonder oplossing
